...
export const metadata: Metadata = {
  ...
  description:
    'Book Chris Marvel — keynote speaker, mental health performance coach, and author of The What If Effect. Trusted by Johnson & Johnson, NFL/NBA athletes, and school districts nationwide. Corporate keynotes, workshops, and training programs starting at $7,500.',
  keywords: [
    'Chris Marvel',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'How much does it cost to book Chris Marvel as a keynote speaker?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Chris Marvel\'s speaking engagements start at $7,500 for corporate keynotes. Education and nonprofit rates are available. Pricing varies based on event type, duration, and customization. Contact Jazmine@pivottraining.us or call (770) 313-1232 for a custom quote.',
      },
    },
    {
      '@type': 'Question',
